...
int main(int argc, char **argv)
{
    ...
    if (prog_idx < 0) {
        fprintf(stderr,
                "Usage: %s [-v|--version] [-petscii] [-charset upper|lower|c64-*|pet-*] [-palette ansi|c64] [-columns 80] [-memory c64|pet|default] [-gfx-title \"title\"] [-gfx-border N] [-fullscreen] <program.bas> [args...]\n",
                argv[0]);
        return 1;
    }
