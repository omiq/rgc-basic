...
320 REM --- Enemy updates every tick ---
330 REM Use seconds-ish phase: (T/PERIOD)*2*pi
340 EX = EX0 + INT(AMP * SIN(6.28318 * (T / PERIOD)))
350 IF EX < 0 THEN EX = 0
360 IF EX > 39 THEN EX = 39
...
510 IF EX <> LXE THEN POKE SCR + EY*WIDTH + LXE, 32
...
550 POKE SCR + EY*WIDTH + EX, 24
560 POKE COL + EY*WIDTH + EX, ECOL
