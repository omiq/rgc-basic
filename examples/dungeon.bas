...
3040 IF P$="A" THEN COL=COL-1 : REM <
3050 IF P$="D" THEN COL=COL+1 : REM >
3060 IF P$="W" THEN ROW=ROW-1 : REM ^ 
3070 IF P$="S" THEN ROW=ROW+1 : REM V
...
6000 REM 
6010 REM ............................
6020 PRINT "{CLEAR}{HOME}{RIGHT}{RIGHT}{DOWN}{DOWN}{DOWN}{CYAN}PRESS KEYS: WASD{WHITE}"
