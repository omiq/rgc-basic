...
880 GOTO 3370
890 PRINT : SRSFLAG=0 : LX=3 : PRINT "{REVERSE ON}{LIGHTBLUE}COMMAND:{REVERSE OFF}{WHITE} "; : GOSUB 5860
...
1870 PRINT : PRINT "{13}LONG RANGE SCAN FOR QUADRANT";Q1;",";Q2
...
3810 PRINT "  {GREEN}+-+-+-+-+-+-+-+-+{WHITE} STARDATE  ";INT(T*10)*.1
3820 FOR I=1 TO 8
3830 I$=RIGHT$(STR$(I),1)
3840 PRINT " ";I$;"{GREEN}:{WHITE}"; : REM BORDER
