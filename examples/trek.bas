#OPTION PETSCII
0 SCREENCODES ON : BACKGROUND 0
1 REM CLASSIC BASIC VERSION, SEE TREK-PORTABLE FOR MODERN 
...
3810 PRINT "  {GREEN}{176}─{178}─{178}─{178}─{178}─{178}─{178}─{178}─┐{WHITE} {LIGHTBLUE}STARDATE{YELLOW}  ";INT(T*10)*.1
3820 FOR I=1 TO 8
3830 I$=RIGHT$(STR$(I),1)
3840 PRINT "{YELLOW}";I$;" {GREEN}{125}{WHITE}"; : REM BORDER
3850 J1=(I-1)*24+1 : J2=(I-1)*24+22
3860 FOR J = J1 TO J2 STEP 3
3870 Z3$=MID$(Q$,J,3)
3880 IF Z3$="   " THEN PRINT " "; : GOTO 3930
3920 PRINT LEFT$(Z3$,1);
3930 IF J=J2 THEN PRINT "{GREEN}{125}{WHITE}";
3940 IF J<>J2 THEN PRINT "{GREEN}{125}{WHITE}";
3950 NEXT J
...
4060 PRINT
4070 NEXT I : PRINT "  {GREEN}{173}─{177}─{177}─{177}─{177}─{177}─{177}─{177}─{189}{WHITE}";
...
4450 FOR J=1 TO 8
4460 IF I=Q1 AND J=Q2 THEN PRINT "{221}"; : GALFLAG=1 : GOTO 4490
4470 IF I=Q1 AND J-1=Q2 THEN GOTO 4490
4480 IF I<>Q1 OR J<>Q2 THEN PRINT "{221}";
...
4520 IF GALFLAG=1 THEN PRINT "{221}"; : GALFLAG=0
4530 NEXT J : GOTO 4620
4540 Z4=I : Z5=1 : GOSUB 5610 : J0=INT(11-.5*LEN(G2$))
4550 PRINT "{221}";
4560 PRINT TAB(J0);G2$;
4580 PRINT TAB(18);"{221}";
4590 Z5=5 : GOSUB 5610 : J0=INT(27-.5*LEN(G2$))
4610 PRINT TAB(J0);G2$; : PRINT TAB(34);"{221}";
4620 IF A=0 AND J=9 AND Q1=I AND Q2=8 THEN PRINT : GOTO 4640
4630 IF A=0 THEN PRINT "{221}"
4640 IF A=5 THEN PRINT
4650 IF I<8 THEN PRINT O2$ : NEXT I
4655 PRINT "  {173}{45}{178}─{177}───{177}───{177}───{177}───{177}───{177}───{177}───{189}" : A1=0 : GOTO 800
4660 REM STATUS REPORT
4670 PRINT : PRINT "{CLR}{REVERSE ON}STATUS REPORT:{REVERSE OFF}";CHR$(13) : X$="" : IF K9>1 THEN X$="S"
