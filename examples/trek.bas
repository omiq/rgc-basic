...
906 IF A$="SLS" THEN PRINT : PRINT "{REVERSE ON}SHORT & LONG RANGE SCAN...{REVERSE OFF}" : GOTO 3570
...
1700 PRINT CHR$(13): PRINT "CHIEF ENGINEER SCOTT REPORTS WARP";
...
4360 IF J=Q2 THEN PRINT " ";J$;"  ";
4370 IF J<>Q2 THEN PRINT J;" ";
4380 NEXT J
4390 PRINT
4400 O1$="  +---+---+---+---+---+---+---+---+"
4410 PRINT O1$ : FORI=1TO8 : I$=STR$(I) : I$=RIGHT$(I$,1)
