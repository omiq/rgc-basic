...
2290 IFK(I,3)<=0THEN PRINT " *** KLINGON DESTROYED ***" : GOTO 2320
2300 PRINT " (SENSOR S SHOW ";INT(K(I,3));" UNITS REMAINING)"
2310 GOTO 2340
2320 K3=K3-1 : K9=K9-1 : Z1=K(I,1) : Z2=K(I,2) : A$=EM$ : GOSUB 5400
2330 K(I,3)=0 : G(Q1,Q2)=G(Q1,Q2)-100 : Z(Q1,Q2)=G(Q1,Q2) : IFK9<=0 THEN GOTO 3510
2340 NEXTI
...
3290 IFRND(1)>.6 OR H/S<=.02THEN GOTO 3330
...
3650 A$=BS$ : Z1=I : Z2=J : GOSUB 5560 : IFZ3=1THEN GOTO 3670
...
3690 IFK3>0THENC$="RED" : GOTO 3710
3700 C$="GREEN" : IFE<E0*.1THENC$="AMBER"
