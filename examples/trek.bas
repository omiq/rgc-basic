...
670 REM ERROR HERE
675 K3=INT(G(Q1,Q2)*.01) : B3=INT(G(Q1,Q2)*.1)-10*K3
...
730 A$=BCOL$ + "E" + FCOL$ : Z1=S1 : Z2=S2
735 GOSUB 5400 
737 IF K3 < 1 THEN GOTO 760
740 FOR I=1 TO K3 : GOSUB 5370 : A$=ECOL$+"K"+FCOL$ : Z1=R1 : Z2=R2
...
780 FOR I=1 TO S3 : GOSUB 5370 : A$=HCOL$+"*"+FCOL$ : Z1=R1 : Z2=R2 : GOSUB 5400 : NEXTI
790 GOSUB 3580
...
5410 REM  LEN(A$) <> 3 THEN PRINT "ERROR HERE ";A$
