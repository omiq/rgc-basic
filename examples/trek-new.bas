...
QuadrantName() : PRINT : IF T0<>T THEN GOTO EnterQuadrant
PRINT "YOUR MISSION BEGINS WITH YOUR STARSHIP"
PRINT "IN THE QUADRANT, ";G2$;"."
SRSFLAG=1
PRINT : Pause() : REM ** PAUSE **
PRINT : GOTO ParseQuadrant
EnterQuadrant: IF ATAKFLAG=1 THEN Pause() : ATAKFLAG=0 : PRINT
...
UnknownCommand: NEXTI : ShowCommands()
GOTO MainLoop
REM COURSE CONTROL BEGINS HERE
Nav: ShowDirections() : REM ** DIRECTION HELPER **
...
T=T+1 : ManeuverEnergy() : GOTO NewQuadrant
...
ShortRangeScan: IF ATAKFLAG=1 THEN PRINT : Pause()
...
IF A1=5 THEN RomanNumeral() : GOTO GalHeaderDone
...
CheckSector() : IF Z3=0 THEN GOTO FindEmptyTop
RETURN
END FUNCTION
...
IF Z5>4 THEN GOTO QuadrantNameB
