...
NEXT I
IF CMD=1 THEN RETURN Nav()
IF CMD=2 THEN RETURN ShortRangeScan()
IF CMD=3 THEN RETURN Lrs()
IF CMD=4 THEN RETURN Phasers()
IF CMD=5 THEN RETURN Torpedo()
IF CMD=6 THEN RETURN Shields()
IF CMD=7 THEN RETURN Damage()
IF CMD=8 THEN RETURN Computer()
IF CMD=9 THEN RETURN ST_MISSIONEND
ShowCommands()
GOTO MainLoop
END FUNCTION
