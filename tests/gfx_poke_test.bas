1 REM GFX POKE test: write characters and colours to screen RAM
2 REM Run with: ./basic-gfx tests/gfx_poke_test.bas
3 REM Screen RAM starts at 1024 (0x0400), colour RAM at 55296 (0xD800)
