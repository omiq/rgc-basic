...
basic-wasm:
	...
	$(EMCC) -w -O2 $(VERSION_DEFINES) -s WASM=1 \
		-s EXPORTED_FUNCTIONS='["_basic_load","_basic_run","_basic_halted","_basic_load_and_run","_basic_apply_arg_string","_basic_get_jsonstatus","_basic_get_httpstatus","_basic_get_version","_basic_get_lasterror","_basic_get_exitcode","_basic_get_exitline","_basic_get_exitreason","_wasm_push_key","_malloc","_free"]' \
...
basic-wasm-raylib: $(RAYLIB_WEB_LIB)
	...
	$(EMCC) -w -O2 $(VERSION_DEFINES) -s WASM=1 -DGFX_VIDEO -DGFX_USE_RAYLIB -Igfx -I$(RAYLIB_WEB_SRC) \
		...
		-s EXPORTED_FUNCTIONS='["_basic_apply_arg_string","_basic_get_jsonstatus","_basic_get_httpstatus","_basic_get_version","_basic_get_lasterror","_basic_get_exitcode","_basic_get_exitline","_basic_get_exitreason","_basic_load_and_run_gfx","_basic_load_and_run_gfx_argline","_wasm_push_key","_wasm_gfx_key_state_set","_wasm_gfx_key_state_clear","_wasm_gfx_key_state_ptr","_wasm_gamepad_buttons_ptr","_wasm_gamepad_axes_ptr","_malloc"]' \
...
check: $(TARGET)$(EXE) gfx_video_test lint transpile
	...
	sh conformance/run.sh ./$(TARGET)$(EXE)
